...
public class RoomController implements InterfaceController<Room, RoomDTO, Integer> {
    ...
    public void read(Context ctx) {
        // request
        Object id = ctx.pathParamAsClass("id", Integer.class).check(this::validatePrimaryKey, "Not a valid id").get();
        // entity
        RoomDTO roomDTO = dao.read((Room) id);
        // response
    ...
    public void create(Context ctx) {
        ...
        Integer hotelId = ctx.pathParamAsClass("id", Integer.class).check(this::validatePrimaryKey, "Not a valid id").get();
    ...
    @Override
    public boolean validatePrimaryKey(Object id)
    {
        return dao.validatePrimaryKey((Room) id);
    }
