...
//            throw new ApiException(dat.TestPackage.TestErrorTypes.NOT_FOUND, "Database error: " + e.getMessage());
//        } catch (Exception e){
//            log.error("Error finding entity with ID: {}",  id, e);
//            throw new ApiException(dat.TestPackage.TestErrorTypes.SERVER_ERROR, "Database error: " + e.getMessage());
//        }
//    }
//
//    @Override
...
//            throw new ApiException(dat.TestPackage.TestErrorTypes.SERVER_ERROR, "Failed to create entity: " + e.getMessage());
//        }
//    }
//
//    @Override
...
//            throw new ApiException(dat.TestPackage.TestErrorTypes.SERVER_ERROR, "Database error has happen: " + e.getMessage());
//        }
//    }
//}
