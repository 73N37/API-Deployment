...
//            throw new ApiException(dat.TestPackage.TestDAO.TestErrorTypes.BAD_REQUEST, "DTO is null");
//        }
//        try {
//            Entity entity = dtoToEntity(dto);
//            if(entity == null){
//                log.error("Entity is null");
//                throw new ApiException(dat.TestPackage.TestDAO.TestErrorTypes.BAD_REQUEST, "Failed to convert DTO to Entity");
//            }
